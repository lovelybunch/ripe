...
Seven roles ship out of the box. The two tools keep separate role files — the skill's are short and holistic, ripe's are checkable facet lists — but the question ids match — so a
