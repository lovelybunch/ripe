...
questions:
  ...
  - id: certifications
    ...
    refusal_ok: true
    ask: >
      Which certifications and audit reports do we hold, and when was each last
      completed? An explicit "none yet" is a correct answer.
    must_cover:
      - Named certifications, or an explicit "none yet"
      - The date of the last audit or report per certification
  ...
  - id: bcp-dr
    ...
    expected_gap: true
    ask: >
      What is our business continuity and disaster recovery posture? Recovery
      objectives, backups, and when it was last tested.
    must_cover:
      - Recovery time and point objectives, or an explicit "not defined"
      - Backup approach and location
      - When continuity was last tested, or says it has not been
---
